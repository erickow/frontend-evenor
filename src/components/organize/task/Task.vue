<template>
  <div class="c-organize-task">
                  ...
                  <b-col>
                    <b-col sm="12" md="4" lg="4">
                      <b-card class="" no-body>
                        <b-button variant="info" v-b-modal="'taskForm'" >Tambah Cardboard</b-button>
                      </b-card>
                    </b-col>
                  </b-col>
                </b-row>
                <draggable v-model="tasks"
                      ...
                      <b-col v-for="mytasks in tasks" :key="mytasks.name" 
                        ...
                        <div class="mytasks-contents">
                          ...
                          <b-card class="mt-2" 
                                      no-body>
                                <b-button variant="primary" v-b-modal="'jobForm'" @click="setTaskId(mytasks.id)">Tambah Rencana</b-button>
                              </b-card>
                        </div>
                      </b-card>
                      </b-col>
      ...
      <b-modal id="jobForm" size="lg" centered hide-footer title="Buat Rencana Baru" >
        <b-form >
          ...
          <br><br><label for="jobComittees">Pilih Comittees</label>
          <!-- <v-select id="jobComittees" v-model="formJob.division" :options="['foo','bar']"></v-select> -->
          <multiselect
            v-model="selectedComittees" 
            :multiple="true"
            :track-by="division"
            :options="comittees"
          ...
          <b-button class="mt-4" variant="outline-primary" block @click="addJob">Buat Rencana</b-button>
        </b-form>
      </b-modal>

      <b-modal id="jobModal" size="lg" centered hide-footer title="Lihat Rencana">
...
export default {
  ...
  methods: {
    ...
    customLabel (option) {
      return `${option.comittee.name} - ${option.division}`
    }
  },
  computed: {
    tasks: {
